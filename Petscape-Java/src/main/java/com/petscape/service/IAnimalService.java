...
public interface IAnimalService {
    Page<AnimalResponse> getAll(com.petscape.entity.Species species, String status, String search, Pageable pageable);

    Page<AnimalResponse> getAvailableForAdoption(com.petscape.entity.Species species, Integer maxAge, String search, Pageable pageable);
